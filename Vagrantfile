...
#  node1.vm.hostname = "node1.test.example.com"
  ...
  node1.vm.provision :shell, :inline => "pip install 'ansible==2.3.1.0'", run: "always"
...
#  node2.vm.hostname = "node2.test.example.com"
  ...
  node2.vm.provision :shell, :inline => "sudo yum install -y epel-release; sudo yum -y install python2 sshpass python-devel gcc; sudo curl https://bootstrap.pypa.io/get-pip.py -o get-pip.py; python get-pip.py; sudo pip install -U pip", run: "always"
  node2.vm.provision :shell, :inline => "pip install 'ansible==2.3.1.0'", run: "always"
...
#  repo.vm.provision :shell, :inline => "sudo yum install -y epel-release; sudo yum -y install python2 sshpass python-devel gcc; sudo curl https://bootstrap.pypa.io/get-pip.py -o get-pip.py; python get-pip.py; sudo pip install -U pip", run: "always"
#  repo.vm.provision :shell, :inline => "pip install 'ansible==2.3.1.0'", run: "always"
